...
public class PauseMenu {
    ...
    private void save(){
        Level level = this.playingScreen.getLevelManager().getCurrLevel();
        int lvlNum = this.playingScreen.getLevelManager().getCurrLevelNumber();
        LevelState.saveLevel(level,lvlNum);
    }
