...
public class Level {
    ...
    private void setupSlingshot(){
        slingShot = new SlingShot(this, 5, background.getCentreY()+ background.getHy()+1.5f, birds);
    }
...
//    }
    public boolean isLost(){
        return birdsLaunched==birds.size()+1 && !pigs.isEmpty();
    }
    ...
    public void increaseBirdsLaunched(int value){
        birdsLaunched+=value;
    }
